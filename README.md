...
| `D_DEST_LIFECYCLE_OBS_01/` | Dest lifecycle observer; BRAM CLEAN; MIG0 dest-AND CLEAR1 BUSY; PACKAGE-qsc A/B CLEAR1 ACK + txn1 GOLD1 P0–P15 + CLEAR2 ACK (GOLD2 incomplete) |
