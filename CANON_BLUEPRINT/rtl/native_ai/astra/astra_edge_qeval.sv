// astra_edge_qeval.sv — common-runtime ASTRA Q-eval over a loaded edge store.
// AGENT_D CANDIDATE. PROGRAM=NO. Not ASTRA_PASS / FE256_PASS.
// Store ROM is pack data (fe256_store.mem), not gold StructuredResult.
// Dedicated fe256_query_path.sv is NOT instantiated (not a hybrid bind).
// Freeze RTL / DCPs are not modified. FE256_DEVELOPMENT remains CLOSED.
`timescale 1ns/1ps
`include "fe256_abi_constants.svh"

module astra_edge_qeval (
  input  logic        clk,
  input  logic        rst_n,
  input  logic        q_valid,
