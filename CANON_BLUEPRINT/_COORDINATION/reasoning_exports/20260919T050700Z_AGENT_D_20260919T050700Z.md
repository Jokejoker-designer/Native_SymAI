...
STRUCTURAL_GUARD:
  Do not overlay dest_accept. Do not strip dest_ui_* without owner overlay identity. Do not add async FIFO only because two clocks exist. word_cdc32 already exact-once.
BLAST_RADIUS:
