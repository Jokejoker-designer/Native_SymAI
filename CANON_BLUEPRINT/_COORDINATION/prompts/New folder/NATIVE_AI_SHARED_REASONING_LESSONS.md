...
LESSON_ID: PACK24-UART-WITHOUT-TAP-FLIP-AND-A03-MUTE-20260920T122400Z
DATE/RUN_ID: 20260920T122400Z
OWNER: CURSOR_OWNER
SITUATION: Parent ran Pack24 run1 on programmed OBS. Watch publishes only.
CLAIM_BEING_TESTED: 24 CLEAR+case UART tokens on OBS close PACK_ABI.
EXPECTED: Do not stamp 24/24. generation_flipped only from TAP four-AND.
OBSERVED: 5 LOAD_OK GOLD. V-03 reject 8. A-02 MAG. A-03/A-04 MUTE n=0. DUT jsonl omits generation_flipped.
SUCCESS_ARTIFACT: PACK24_RUN1.json f8379872…; DUT jsonl 560eb157…
FAILURE_ARTIFACT: PACK_ABI=NO; MUTE A-03/A-04; no TAP flip
EVIDENCE_PATHS_AND_HASHES: PACK24_RUN1.json f8379872674acda83ee5456c0d2b94ceaf79d24ae048c409870cdd1b53e7f4d1
EVIDENCE_LEVEL: UART campaign CANDIDATE. Not PACK_ABI. Not BOARD_PASS. Not PROGRAM_PASS.
FIRST_DIVERGENCE: A-02 MAG then A-03 MUTE; V-03 0200085a vs GOLD.
ROOT_CAUSE_OR_UNKNOWN: MUTE UNKNOWN. MAG leftover OPEN. V-03 R08 UNKNOWN vs VALID expect.
WHY_THE_INITIAL_INFERENCE_FAILED: Isolated V-04 GOLD and 4/4 GOLD do not imply 24 ABI cases.
GENERAL_RULE: Do not stamp PACK_ABI from 5 GOLD. UART GOLD is not TAP four-AND. Watch does not Pack24.
SMALLEST_DECISIVE_REPRODUCER: PACK24_RUN1_DUT.jsonl + PACK24_RUN1.json A-03 n=0
STRUCTURAL_GUARD_OR_TEST: This watch Pack24=NO PACK_ABI=NO PROGRAM_PASS=NO BOARD_PASS=NO
BLAST_RADIUS: OBS SRAM campaign. Frozen identities untouched.
NEXT_OWNER_ACTION: Do not stamp 24/24. Watch does not re-run Pack24.
