# Synth arty_a7_mig_top with uart_tx_word + u_cdc_tx. CANDIDATE. PROGRAM=NO.
# Separate out dir: do not clobber mig_uiclk/post_route.dcp (bag2 MET, no TX).
...
set out {D:/FPGA/arty_d/mig_tx}
file mkdir $out
file mkdir [file join $out reports]
cd $out

create_project mig_tx $out -part xc7a100tcsg324-1 -force
