# Synth isolated M4 QueryRecord→StructuredResult UART candidate. PROGRAM=NO.
# Not frozen r2_top / R2_FE256_R1_INTEGRATED_FREEZE / FE256_R1_REFERENCE_FREEZE.
# No fe256_query_path. Not TIMING_PASS / ASTRA_PASS / BOARD_PASS.
...
read_verilog -sv [file join $rtl board arty_a7_r2_top_m4_query_result_candidate.sv]
...
synth_design -top arty_a7_r2_top_m4_query_result_candidate -part xc7a100tcsg324-1 -flatten_hierarchy rebuilt
...
puts "M4_QUERY_RESULT_SHADOW_SYNTH_DONE"
exit
