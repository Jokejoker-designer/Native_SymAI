# OOC synth query_posting_bind xc7a100t 100 MHz. CANDIDATE. PROGRAM=NO.
# Isolated from freeze tops and FE256 engine.
...
read_verilog -sv [file join $root rtl native_ai directory query_posting_bind.sv]
synth_design -mode out_of_context -top query_posting_bind -part xc7a100tcsg324-1 -flatten_hierarchy rebuilt
...
puts "M2_QUERY_POST_OOC_SYNTH_DONE"
exit
