# OOC synth query_walk_bind xc7a100t 100 MHz. CANDIDATE. PROGRAM=NO.
...
synth_design -mode out_of_context -top query_walk_bind -part xc7a100tcsg324-1 -flatten_hierarchy rebuilt
...
puts "M3_QUERY_WALK_OOC_SYNTH_DONE"
exit
