...
PACKAGE-qsc A/B (`run_obs01_mig0_pkgqsc.bat`): TB `QSC_USE_DEST_RDY=0`. `$finish` Q1 YES Q2 YES Q3 NO Q4 NEW_COMMIT. `PACKAGE_QSC_MIG0_PATH_THIS_SEQUENCE=CLEAN`. Does **not** patch product bind. `PACK_ABI_24_24_PASS=NO`.
