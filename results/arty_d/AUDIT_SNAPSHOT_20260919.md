...
| `OBS01_MIG0_PKGQSC.md` | PACKAGE-qsc CLEAN Q1 YES Q2 YES Q3 NO Q4 NEW_COMMIT GOLD2; PACK_ABI=NO |
...
PACKAGE-qsc A/B (`OBS01_MIG0_PKGQSC.md` / `out/xsim_mig0_pkgqsc.log`): `$finish` 4958414625 ps. Q1 YES Q2 YES Q3 NO Q4 NEW_COMMIT GOLD2 `010000a5`. `PACKAGE_QSC_MIG0_PATH_THIS_SEQUENCE=CLEAN` PASS_XSIM (TB-forced dest ready). U32 dest-AND still `FAIL_XSIM_CLEAR1_BUSY`. `PACK_ABI_24_24_PASS=NO`. `MIG0_BOARD_CAUSAL_CLASS=STILL_OPEN`.
