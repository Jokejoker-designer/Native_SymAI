// UART_R2_U27 overlay. Do not patch frozen U20/U22/U24/U25/U26.
// U25 exclusive FAIL: p4 GOLD + p5 r0/r1 GOLD then r2 V-04 n=0 after ACK.
// U26 loader-only mig_ui32 reset: p4 GOLD + r0 GOLD then r1 V-04 n=0. CONTRADICTED as 24/24 fix.
// U27 keeps U25 UART (st_fire FIFO flush, TX.flush=uart_flush, exact BEGIN).
// Soft CLEAR: ACK when quiescent without debug_clear.
