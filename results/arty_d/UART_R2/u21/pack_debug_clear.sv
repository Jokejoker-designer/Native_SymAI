// pack_debug_clear.sv — UART_R2_U21 CLEAR FSM = frozen U20 copy.
// U20 FAIL_BOARD exclusive: Phase4 ACK+GOLD then Phase5 CLEAR r0 n=0.
// Flush still S_CDC|S_QUIET plus ONE S_DROP cycle (RX/FIFO only in U21 overlay).
