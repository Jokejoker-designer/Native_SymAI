"""U29 board campaign: MARK 2s, exact n=4 ACK/GOLD, then Pack24.
...
u9mod.OUT = Path(r"D:\FPGA\arty_d\UART_R2\results\PACK24_U29")
OUT = u9mod.OUT
RAW = OUT / "RAW_UART"
BIT = Path(r"D:\FPGA\arty_d\UART_R2\build_u29\uart_r2_u29_candidate.bit")
WANT = "c02c3343b7076a9ff2a95d88488a926130979396af5f46baa86b6164aaa0190c"
TSV = Path(
