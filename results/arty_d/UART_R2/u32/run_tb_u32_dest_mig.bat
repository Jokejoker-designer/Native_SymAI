...
if not exist "%R2%\xsim_u32m" mkdir "%R2%\xsim_u32m"
cd /d "%R2%\xsim_u32m"
copy /Y "%PA%\out\PA24-V-04.mem" "%R2%\xsim_u32m\" >nul
call xvlog -sv ^
  ...
  "%R2%\u32\tb_u32_dest_mig_class.sv"
if errorlevel 1 exit /b 1
call xelab tb_u32_dest_mig_class -s tb_u32m -timescale 1ns/1ps
if errorlevel 1 exit /b 1
call xsim tb_u32m -runall
exit /b %ERRORLEVEL%
