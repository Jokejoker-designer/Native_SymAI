"""U32 board campaign: MARK 2s, exact n=4 ACK/GOLD, then Pack24.
...
u9mod.OUT = Path(r"D:\FPGA\arty_d\UART_R2\results\PACK24_U32")
OUT = u9mod.OUT
RAW = OUT / "RAW_UART"
BIT = Path(r"D:\FPGA\arty_d\UART_R2\build_u32\uart_r2_u32_candidate.bit")
WANT = "0df4de2ec075bfdbe567bb661702da088a1be5322cc9112ad2ebf959d116f6ff"
TSV = Path(
