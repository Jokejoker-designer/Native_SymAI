...
if not exist "%R2%\xsim_u32l" mkdir "%R2%\xsim_u32l"
cd /d "%R2%\xsim_u32l"
copy /Y "%PA%\out\PA24-V-04.mem" "%R2%\xsim_u32l\" >nul
call xvlog -sv ^
  ...
  "%R2%\u32\tb_u32_leftover_op01.sv"
if errorlevel 1 exit /b 1
call xelab tb_u32_leftover_op01 -s tb_u32l -timescale 1ns/1ps
if errorlevel 1 exit /b 1
call xsim tb_u32l -runall
if errorlevel 1 exit /b 1

if not exist "%R2%\xsim_u32t" mkdir "%R2%\xsim_u32t"
cd /d "%R2%\xsim_u32t"
copy /Y "%PA%\out\PA24-V-04.mem" "%R2%\xsim_u32t\" >nul
call xvlog -sv ^
  "%RTL%\common\crc32_iso_hdlc.sv" ^
  "%RTL%\loader\pack_loader.sv" ^
  "%RTL%\memory\mig_ui32.sv" ^
  ...
  "%R2%\u32\pack_clear_ui.sv" ^
  "%R2%\u32\pack_uart_dualclk_harness.sv" ^
  "%R2%\u32\tb_u32_two_v04.sv"
if errorlevel 1 exit /b 1
call xelab tb_u32_two_v04 -s tb_u32t -timescale 1ns/1ps
if errorlevel 1 exit /b 1
call xsim tb_u32t -runall
exit /b %ERRORLEVEL%
