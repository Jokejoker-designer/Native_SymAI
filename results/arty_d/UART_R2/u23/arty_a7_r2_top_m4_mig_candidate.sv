// UART_R2_U23 overlay. Frozen U22 not edited.
// U22 FAIL_BOARD exclusive: CLEAR1 n=0. Observe via fpgacapZero ELA (BSCANE2),
// not Xilinx ILA (BASIC license blocks create_debug_core).
// Same mux/CLEAR/TX as U22 + dbg_st tap + fcapz_ela_xilinx7.
// CANDIDATE / DEBUG. PROGRAM=NO. Not MIG_PASS / TIMING_PASS / BOARD_PASS / ASTRA_PASS.
// Do not overwrite freeze DCPs or identity H. LiteX NOT_ADOPTED.
`timescale 1ns/1ps
...
module arty_a7_r2_top_m4_mig_candidate (
  ...
  // fcapz ELA probe map SAMPLE_W=64. LSB=take for value_match mask=1.
  // [0] take  [4] hold  [5] flush  [6] mux_ready  [7] ack_valid
  // [8] w_valid [9] w_ready [10] pack_lock [11] fifo_empty
  // [12] uart_tx_valid [13] st_valid_100 [14] qsc_100 [15] mux_valid
  // [16] fifo_wr_ready [17] rx_idle [18] fifo_flush [19] cdc_rst_100
  // [20] clr_ack_ready [21] clr_ui_req [22] ack_c1 [23] nack_c1
  // [31:28] clr_st  [63:32] w_data
  logic [63:0] ela_probe;
  assign ela_probe = {
    w_data,
    clr_st,
    4'h0,
