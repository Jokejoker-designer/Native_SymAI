"""UART_R2_U9 board: 12s settle, CLEAR, V-04, CLEAR2. Writes only build_u9/board_test.
...
OUT = Path(r"D:\FPGA\arty_d\UART_R2\build_u9\board_test")
BIT = Path(r"D:\FPGA\arty_d\UART_R2\build_u9\uart_r2_u9_candidate.bit")
GOLD = Path(
...
def kill_jtag_usb_servers() -> None:
