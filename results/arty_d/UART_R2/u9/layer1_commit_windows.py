"""Layer 1 host commit windows on UART_R2_U9. One COM session.
...
def main() -> int:
    ...
    try:
        ...
        for rnd in range(ROUNDS):
            ...
            recs.append({"step": "CLEAR_AFTER_GOLD", "round": rnd, **c2})
