// pack_debug_clear.sv — UART_R2_U9 candidate. VALIDATION ONLY.
// U9 = U8 ACK-hold + CDC overlap through S_DROP (A reset until IDLE).
// Identity != H, != U3 RX, != U8 bit. Does not overwrite PACKAGE live.
`timescale 1ns/1ps
...
module pack_debug_clear (
  ...
  always_ff @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      // U9 DROP in cdc_rst: A reset while B live after ACK. Board U9b MAG
      // 0200015a vs U8 GOLD on same host. Release A with B at DROP (U8).
