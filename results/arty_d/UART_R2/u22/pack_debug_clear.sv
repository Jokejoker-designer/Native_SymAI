// pack_debug_clear.sv — UART_R2_U22 CLEAR FSM = frozen U20/U21 copy.
// U21 FAIL_BOARD exclusive: CLEAR ACK then V-04 n=0.
// Flush S_CDC|S_QUIET plus ONE S_DROP cycle (RX/FIFO). Overlay does not FIFO-flush on pack_lock fall.
// Must NOT flush S_REQ (U16) or S_ACK (U10). MAG cdc_rst = S_CDC|S_QUIET|S_ACK.
// Do not edit frozen u21. CANDIDATE.
`timescale 1ns/1ps
