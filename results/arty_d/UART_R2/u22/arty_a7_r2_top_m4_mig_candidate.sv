// UART_R2_U22 overlay. Frozen U21 not edited.
// U21 FAIL_BOARD exclusive: CLEAR ACK then V-04 n=0.
// U21 added FIFO flush on pack_lock fall; that can wipe in-flight V-04.
// U22: fifo_flush = uart_flush only. Keep TX.flush=0 and clr_ack_ready=mux_ready.
// U20 one-cycle DROP RX/FIFO flush. U19 steer_pack. CANDIDATE.
