"""U22 board campaign: MARK 2s, exact n=4 ACK/GOLD, then Pack24.
Not PROGRAM_PASS / BOARD_PASS / PACK_ABI_24_24_PASS.
WANT filled after bit. Do not program U21 09736afe.
"""
...
u9mod.OUT = Path(r"D:\FPGA\arty_d\UART_R2\results\PACK24_U22")
OUT = u9mod.OUT
RAW = OUT / "RAW_UART"
BIT = Path(r"D:\FPGA\arty_d\UART_R2\build_u22\uart_r2_u22_candidate.bit")
WANT = "ba45936f117e0d8eb6b903dc498dc66e4c36f94314bdcaa8afd366306f8a2be9"
TSV = Path(
...
def main() -> int:
    ...
    if mode == "settle":
        ...
        return 0
    kill_jtag_usb_servers()
    print("MIG_SETTLE_S", MIG_SETTLE_S)
    time.sleep(MIG_SETTLE_S)
    port = find_port()
    if not port:
        print("NO_COM")
        return 2
