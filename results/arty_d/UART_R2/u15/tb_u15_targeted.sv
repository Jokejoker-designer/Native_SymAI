// tb_u15_targeted.sv — UART_R2_U15 targeted XSim before bitstream.
// RX=U11 CLEAR=U8 TX=U10 CDC=PACKAGE. Not BOARD_PASS.
`timescale 1ns/1ps

module tb_u15_targeted;
  ...
  initial begin
    ...
    if (fail == 0 && mag_n == 0 && n0_n == 0 && unsup_n == 0)
      $display("UART_R2_U15_TARGETED_XSIM_PASS pass=%0d warn=%0d (not BOARD_PASS)", pass, warn);
    else
      $display("UART_R2_U15_TARGETED_XSIM_FAIL fail=%0d pass=%0d mag=%0d n0=%0d", fail, pass, mag_n, n0_n);
    $finish;
  end
endmodule
