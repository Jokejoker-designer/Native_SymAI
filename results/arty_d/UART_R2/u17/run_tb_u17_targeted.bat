...
if not exist "%OUT%\xsim_u17t" mkdir "%OUT%\xsim_u17t"
cd /d "%OUT%\xsim_u17t"
call "%XV%\xvlog.bat" -sv ^
  "%OUT%\u11\uart_rx_word.sv" ^
  "%OUT%\u14\uart_tx_word.sv" ^
  "%OUT%\u17\pack_debug_clear.sv" ^
  "%PKG%\rtl\native_ai\board\pack_clear_ui.sv" ^
  "%OUT%\lib\word_cdc32.sv" ^
  "%OUT%\u15\tb_u15_targeted.sv"
if errorlevel 1 exit /b 1
call "%XV%\xelab.bat" tb_u15_targeted -s tb_u17t -timescale 1ns/1ps
if errorlevel 1 exit /b 1
call "%XV%\xsim.bat" tb_u17t -runall
exit /b %ERRORLEVEL%
