"""U17 board campaign: MARK 2s, exact n=4 ACK/GOLD, then Pack24.
...
u9mod.OUT = Path(r"D:\FPGA\arty_d\UART_R2\results\PACK24_U17")
OUT = u9mod.OUT
RAW = OUT / "RAW_UART"
BIT = Path(r"D:\FPGA\arty_d\UART_R2\build_u17\uart_r2_u17_candidate.bit")
