...
if not exist "%R2%\xsim_u31s" mkdir "%R2%\xsim_u31s"
cd /d "%R2%\xsim_u31s"
copy /Y "%PA%\out\PA24-V-04.mem" "%R2%\xsim_u31s\" >nul
call xvlog -sv ^
  ...
  "%R2%\u31\tb_u31_dest_stall_clear.sv"
if errorlevel 1 exit /b 1
call xelab tb_u31_dest_stall_clear -s tb_u31s -timescale 1ns/1ps
if errorlevel 1 exit /b 1
call xsim tb_u31s -runall
exit /b %ERRORLEVEL%
