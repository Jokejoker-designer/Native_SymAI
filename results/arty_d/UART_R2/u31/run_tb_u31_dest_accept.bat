...
if not exist "%R2%\xsim_u31m" mkdir "%R2%\xsim_u31m"
cd /d "%R2%\xsim_u31m"
copy /Y "%PA%\out\PA24-V-04.mem" "%R2%\xsim_u31m\" >nul
call xvlog -sv ^
  ...
  "%R2%\u31\tb_u31_dest_accept_mute.sv"
if errorlevel 1 exit /b 1
call xelab tb_u31_dest_accept_mute -s tb_u31m -timescale 1ns/1ps
if errorlevel 1 exit /b 1
call xsim tb_u31m -runall
exit /b %ERRORLEVEL%
