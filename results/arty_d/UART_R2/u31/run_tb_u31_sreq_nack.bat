...
if not exist "%R2%\xsim_u31r" mkdir "%R2%\xsim_u31r"
cd /d "%R2%\xsim_u31r"
copy /Y "%PA%\out\PA24-V-04.mem" "%R2%\xsim_u31r\" >nul
call xvlog -sv ^
  ...
  "%R2%\u31\tb_u31_sreq_nack_leftover.sv"
if errorlevel 1 exit /b 1
call xelab tb_u31_sreq_nack_leftover -s tb_u31r -timescale 1ns/1ps
if errorlevel 1 exit /b 1
call xsim tb_u31r -runall
exit /b %ERRORLEVEL%
