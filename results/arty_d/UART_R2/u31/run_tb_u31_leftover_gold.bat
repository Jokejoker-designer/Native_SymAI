...
if not exist "%R2%\xsim_u31g" mkdir "%R2%\xsim_u31g"
cd /d "%R2%\xsim_u31g"
copy /Y "%PA%\out\PA24-V-04.mem" "%R2%\xsim_u31g\" >nul
call xvlog -sv ^
  ...
  "%R2%\u31\tb_u31_leftover_gold_hunt.sv"
if errorlevel 1 exit /b 1
call xelab tb_u31_leftover_gold_hunt -s tb_u31g -timescale 1ns/1ps
if errorlevel 1 exit /b 1
call xsim tb_u31g -runall
exit /b %ERRORLEVEL%
