"""Reprogram U31 exclusive, 12s settle, then no-warmup p4+p5."""
...
PROG = Path(r"D:\FPGA\arty_d\UART_R2\u31\run_program_u31.bat")
CAMP = Path(r"D:\FPGA\arty_d\UART_R2\u31\u31_campaign.py")
KILL = Path(r"D:\FPGA\arty_d\UART_R2\u31\kill_com12_holders.py")
SETTLE_S = 12.0
