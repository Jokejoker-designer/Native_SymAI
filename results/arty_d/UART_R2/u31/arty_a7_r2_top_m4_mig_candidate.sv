// UART_R2_U31 overlay. Do not patch frozen U20/U22/U24/U25/U26/U27/U28.
// U25 FAIL r2 n=0. U26 r1 n=0. U28 SETTLE FAIL r0 n=0 after ACK (V04 during dest reset).
// U31: drop debug_clear/cdc_rst before ACK TX; drain before clear; qsc needs app_rdy. No SETTLE 2048. Do not patch U30.
