"""U31 board campaign: MARK 2s, exact n=4 ACK/GOLD, then Pack24.
...
u9mod.OUT = Path(r"D:\FPGA\arty_d\UART_R2\results\PACK24_U31")
OUT = u9mod.OUT
RAW = OUT / "RAW_UART"
BIT = Path(r"D:\FPGA\arty_d\UART_R2\build_u31\uart_r2_u31_candidate.bit")
WANT = "08cbb85430060acafaeee2aa9d63948be1e460e70ee02f3ca56450a5a2cce28d"
TSV = Path(
