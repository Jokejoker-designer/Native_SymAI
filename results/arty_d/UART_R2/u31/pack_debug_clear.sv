// pack_debug_clear.sv — UART_R2_U31 CLEAR overlay. Do not patch frozen U20/U30.
...
// U31: ui_req + cdc_rst only S_REQ|S_CDC|S_QUIET. Dest leaves reset before ACK TX.
// Flush still U20: S_CDC|S_QUIET plus one DROP cycle. CANDIDATE.
`timescale 1ns/1ps
