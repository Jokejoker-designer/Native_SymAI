// UART_R2_U25 overlay. Do not patch frozen U20/U22/U24.
// U24 exclusive: GOLD then Phase5 r1 V-04 n=0. U21 unlock-flush killed GOLD.
// U25: FIFO flush only when GOLD/NAK word is accepted by TX (st_fire).
// TX.flush stays uart_flush. Unlocked steer = exact BEGIN 00800001.
// Query UART leftover disabled (M1 pack overlay). CANDIDATE.
