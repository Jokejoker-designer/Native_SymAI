// UART_R2_U28 overlay. Do not patch frozen U20/U22/U24/U25/U26/U27.
// U25 exclusive FAIL: 3 GOLD then r2 V-04 n=0. U26 loader-only reset: r1 n=0.
// U27 soft CLEAR: XSim V04_2 mute, not programmed.
// U28 keeps U25 UART. debug_clear resets loader+ui32 then SETTLE 2048 ui_clk.
