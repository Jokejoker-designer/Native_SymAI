// pack_debug_clear.sv — UART_R2_U16.
// U15 board: CLEAR ACK then V-04 mute, then BUSY, then n=0.
// U15 added cdc_rst at S_REQ (RX CDC A reset while UI B still live).
// That class is pack-path mute, not MAG token.
// U16: keep uart_flush through S_REQ (kills extra 0-word before ACK, harness PASS).
// Restore MAG cdc_rst = S_CDC|S_QUIET|S_ACK only. Do not edit frozen u15.
`timescale 1ns/1ps
