"""U24 board campaign: MARK 2s, exact n=4 ACK/GOLD, then Pack24.
...
u9mod.OUT = Path(r"D:\FPGA\arty_d\UART_R2\results\PACK24_U24")
OUT = u9mod.OUT
RAW = OUT / "RAW_UART"
BIT = Path(r"D:\FPGA\arty_d\UART_R2\build_u24\uart_r2_u24_candidate.bit")
WANT = "1cb7dad768bdca96f8a04bd88b85e3684c44ca528760b3c6126dbab023087b6a"
TSV = Path(
