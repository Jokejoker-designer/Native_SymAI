...
call xvlog -work u33obs -sv ^
  ...
  "%R2%\u33obs\tb_u33obs_leftover_lane.sv"
if errorlevel 1 exit /b 1
call xelab u33obs.tb_u33obs_leftover_lane -L u33obs -s tb_u33obs_lane -debug off -timescale 1ns/1ps
if errorlevel 1 exit /b 1
call xsim tb_u33obs_lane -tclbatch run.tcl -log xsim_u33obs_lane.log
exit /b %ERRORLEVEL%
