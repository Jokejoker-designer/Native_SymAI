...
set bitfile [file join $out uart_r2_u33obs_steer_candidate.bit]
...
if {$outn ne [file normalize {D:/FPGA/arty_d/UART_R2/build_u33obs_steer}]} { r2_fail WRONG_OUT $outn }
...
puts $fh "READY_TO_PROGRAM=NO"
close $fh
puts "uart_r2_u33obs_steer_BIT_OK path=$bitfile PROGRAM=NO"
exit 0
