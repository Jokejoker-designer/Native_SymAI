# Synth UART_R2 U33OBS CLEAR TAP re-arm. NEW dir, does not overwrite build_u33obs.
...
set want [file normalize {D:/FPGA/arty_d/UART_R2/build_u33obs_rearm}]
...
create_project uart_r2_u33obs_rearm $out -part xc7a100tcsg324-1 -force
...
puts "uart_r2_u33obs_rearm_SYNTH_OK path=$out TAP_CDC_CELLS=$ntap U2UI=$nu2u"
exit 0
