...
call xvlog -work u33obs -sv ^
  ...
  "%R2%\u33obs\pack_hop_log.sv" ^
  "%R2%\u33obs\tb_u33obs_leftover_hoplog.sv"
if errorlevel 1 exit /b 1
call xelab u33obs.tb_u33obs_leftover_hoplog -L u33obs -s tb_u33obs -debug off -timescale 1ns/1ps
if errorlevel 1 exit /b 1
call xsim tb_u33obs -tclbatch run.tcl -log xsim_u33obs_hoplog.log
exit /b %ERRORLEVEL%
