...
set OUT=%R2%\xsim_u33obs_tapdump
...
call xvlog -work u33obst -sv ^
  ...
  "%R2%\u33obs\tb_u33obs_tapdump.sv"
if errorlevel 1 exit /b 1
call xelab u33obst.tb_u33obs_tapdump -L u33obst -s tb_u33obs_tapdump -debug off -timescale 1ns/1ps
if errorlevel 1 exit /b 1
call xsim tb_u33obs_tapdump -tclbatch run.tcl -log xsim_u33obs_tapdump.log
exit /b %ERRORLEVEL%
