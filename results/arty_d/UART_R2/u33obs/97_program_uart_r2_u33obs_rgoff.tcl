# Program U33OBS rg_off only. Requires tclargs OUTDIR OWNER_AUTHORIZED.
# Ban H / U33 / TAPCDC / old OBS 71b9198f / M4+mig. Kill hw_server after.
...
set bitfile {D:/FPGA/arty_d/UART_R2/build_u33obs_rgoff/uart_r2_u33obs_rgoff_candidate.bit}
set want_sha {251eafa9451cabd83089fc5cba0c6351f1955c27a70dd9a60e7e2321f4910764}
...
proc prog_fail {cut msg} {
  ...
  close $fh
  puts "uart_r2_u33obs_rgoff_PROG_ABORT $cut $msg"
...
if {![string match {*/UART_R2/build_u33obs_rgoff/*} $bitn_fwd]} { prog_fail BIT_NOT_IN_rgoff $bitn }
...
puts "uart_r2_u33obs_rgoff_SHA_OK $hash_out"
...
puts $pfh "CLASS=uart_r2_u33obs_RGOFF_CANDIDATE"
...
close $pfh
puts "uart_r2_u33obs_rgoff_PROGRAM_OK target=$tgt sha=$hash_out PROGRAM_PASS=NO"
catch {close_hw_target}
catch {disconnect_hw_server}
catch {close_hw_manager}
