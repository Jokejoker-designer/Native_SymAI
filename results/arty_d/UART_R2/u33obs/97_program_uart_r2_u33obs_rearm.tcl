# Program U33OBS CLEAR TAP re-arm only. Requires tclargs OUTDIR OWNER_AUTHORIZED.
# Ban H / U33 / TAPCDC / old OBS / rg_off / steer bd541f95 / M4+mig.
...
set bitfile {D:/FPGA/arty_d/UART_R2/build_u33obs_rearm/uart_r2_u33obs_rearm_candidate.bit}
set shafile {D:/FPGA/arty_d/UART_R2/build_u33obs_rearm/SHA256.txt}
...
proc prog_fail {cut msg} {
  ...
  close $fh
  puts "uart_r2_u33obs_rearm_PROG_ABORT $cut $msg"
...
if {![string match {*/UART_R2/build_u33obs_rearm/*} $bitn_fwd]} { prog_fail BIT_NOT_IN_rearm $bitn }
if {[string match *uart_r2_u33_candidate* $bitn_fwd] || [string match *m4_mig* $bitn_fwd] || [string match *u33tap* $bitn_fwd] || [string match *u33obs_steer* $bitn_fwd]} {
...
puts "uart_r2_u33obs_rearm_SHA_OK $hash_out"
...
puts $pfh "CLASS=uart_r2_u33obs_REARM_CANDIDATE"
...
puts $pfh "NOT_U33OBS_71b9198f=YES"
puts $pfh "NOT_U33OBS_RGOFF_251eafa9=YES"
puts $pfh "NOT_U33OBS_STEER_bd541f95=YES"
close $pfh
puts "uart_r2_u33obs_rearm_PROGRAM_OK target=$tgt sha=$hash_out PROGRAM_PASS=NO"
catch {close_hw_target}
catch {disconnect_hw_server}
catch {close_hw_manager}
