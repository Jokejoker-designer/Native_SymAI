# Synth UART_R2 U33OBS. Writes ONLY build_u33obs. U33/H/U33TAP frozen. PROGRAM=NO.
set out {D:/FPGA/arty_d/UART_R2/build_u33obs}
...
proc r2_fail {cut msg} {
  ...
  close $fh
  puts "uart_r2_u33obs_ABORT $cut $msg"
  exit 1
}

set outn [file normalize $out]
set want [file normalize {D:/FPGA/arty_d/UART_R2/build_u33obs}]
...
foreach bad {
  ...
  {D:/FPGA/arty_d/UART_R2/build_u32}
...
create_project uart_r2_u33obs $out -part xc7a100tcsg324-1 -force
...
puts $fh "OUT=$out"
puts $fh "CLASS=uart_r2_u33obs_CANDIDATE"
...
puts "uart_r2_u33obs_SYNTH_OK path=$out TAP_CDC_CELLS=$ntap U2UI=$nu2u"
exit 0
