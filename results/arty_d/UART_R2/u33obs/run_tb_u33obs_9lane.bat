...
call xvlog -work u33obs9 -sv ^
  ...
  "%R2%\u33obs\pack_obs_hops.sv" ^
  "%R2%\u33obs\pack_obs_9lane.sv" ^
  "%R2%\u33obs\pack_obs_harness.sv" ^
  "%R2%\u33obs\tb_u33obs_9lane.sv"
if errorlevel 1 exit /b 1
call xelab u33obs9.tb_u33obs_9lane -L u33obs9 -s tb_u33obs_9lane -debug off -timescale 1ns/1ps
if errorlevel 1 exit /b 1
call xsim tb_u33obs_9lane -tclbatch run.tcl -log xsim_u33obs_9lane.log
exit /b %ERRORLEVEL%
