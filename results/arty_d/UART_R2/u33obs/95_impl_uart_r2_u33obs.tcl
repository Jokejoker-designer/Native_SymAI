# Impl U33OBS with TAP CDC XDC at place/route. Unique build_u33obs.
...
if {$outn ne [file normalize {D:/FPGA/arty_d/UART_R2/build_u33obs}]} { r2_fail WRONG_OUT $outn }
file mkdir $out
...
puts $fh "READY_TO_PROGRAM=NO"
close $fh
puts "uart_r2_u33obs_ROUTE_OK path=$out"
exit 0
