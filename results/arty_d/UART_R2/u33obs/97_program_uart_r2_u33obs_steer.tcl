# Program U33OBS OP_BEGIN steer only. Requires tclargs OUTDIR OWNER_AUTHORIZED.
# Ban H / U33 / TAPCDC / old OBS 71b9198f / rg_off 251eafa9 / M4+mig. Kill hw_server after.
...
set bitfile {D:/FPGA/arty_d/UART_R2/build_u33obs_steer/uart_r2_u33obs_steer_candidate.bit}
set want_sha {bd541f9579dfe0e2ca1b9dc4e220818fe460e293e6a7c42c08ecf8652fc9b46f}
...
proc prog_fail {cut msg} {
  ...
  close $fh
  puts "uart_r2_u33obs_steer_PROG_ABORT $cut $msg"
...
if {![string match {*/UART_R2/build_u33obs_steer/*} $bitn_fwd]} { prog_fail BIT_NOT_IN_steer $bitn }
...
puts "uart_r2_u33obs_steer_SHA_OK $hash_out"
...
puts $pfh "CLASS=uart_r2_u33obs_STEER_CANDIDATE"
...
close $pfh
puts "uart_r2_u33obs_steer_PROGRAM_OK target=$tgt sha=$hash_out PROGRAM_PASS=NO"
catch {close_hw_target}
catch {disconnect_hw_server}
catch {close_hw_manager}
