"""Reprogram U30 exclusive, 12s settle, then no-warmup p4+p5."""
...
PROG = Path(r"D:\FPGA\arty_d\UART_R2\u30\run_program_u30.bat")
CAMP = Path(r"D:\FPGA\arty_d\UART_R2\u30\u30_campaign.py")
KILL = Path(r"D:\FPGA\arty_d\UART_R2\u30\kill_com12_holders.py")
SETTLE_S = 12.0
