"""U30 board campaign: MARK 2s, exact n=4 ACK/GOLD, then Pack24.
...
u9mod.OUT = Path(r"D:\FPGA\arty_d\UART_R2\results\PACK24_U30")
OUT = u9mod.OUT
RAW = OUT / "RAW_UART"
BIT = Path(r"D:\FPGA\arty_d\UART_R2\build_u30\uart_r2_u30_candidate.bit")
WANT = "9f999be9e1f74623dfe5437bdf98a71ab7fb9076b5e4e89d9bb626714083335e"
TSV = Path(
