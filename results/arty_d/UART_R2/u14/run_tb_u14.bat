...
if not exist "%OUT%\xsim_u14" mkdir "%OUT%\xsim_u14"
cd /d "%OUT%\xsim_u14"
call "%XV%\xvlog.bat" -sv ^
  ...
  "%OUT%\u14\tb_u14_targeted.sv"
if errorlevel 1 exit /b 1
call "%XV%\xelab.bat" tb_u14_targeted -s tb_u14 -timescale 1ns/1ps
if errorlevel 1 exit /b 1
call "%XV%\xsim.bat" tb_u14 -runall
exit /b %ERRORLEVEL%
