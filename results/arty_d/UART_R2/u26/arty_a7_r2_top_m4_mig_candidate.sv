// UART_R2_U26 overlay. Do not patch frozen U20/U22/U24/U25.
// U25 exclusive FAIL: p4 GOLD + p5 r0/r1 GOLD then r2 V-04 n=0 after CLEAR ACK.
// U25 host WAIT 1s: p5 r0 V-04 MAG 0200015a — not a drain fix.
// U26 keeps U25 UART (st_fire FIFO flush, TX.flush=uart_flush, exact BEGIN).
// debug_clear resets pack_loader only; mig_ui32 stays on rst_n (mig0 UI live).
