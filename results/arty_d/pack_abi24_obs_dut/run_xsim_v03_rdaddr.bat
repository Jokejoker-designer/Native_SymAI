...
set XD=D:\FPGA\arty_d\pack_abi24_obs_dut\xsim_v03
...
call xvlog -work pa24v03 -sv -i "%PA%" -i "%PA%\out" ^
  ...
  "D:\FPGA\arty_d\pack_abi24_obs_dut\tb_v03_rdaddr.sv"
if errorlevel 1 exit /b 1
call xelab pa24v03.tb_v03_rdaddr -L pa24v03 -s tb_v03_rd -timescale 1ns/1ps
if errorlevel 1 exit /b 1
echo run -all> "%XD%\run_all.tcl"
echo exit>> "%XD%\run_all.tcl"
call xsim tb_v03_rd -tclbatch run_all.tcl -log "%XD%\xsim.log"
exit /b %ERRORLEVEL%
