...
set TB=%ROOT%\tb\native_ai\board
set XD=D:\FPGA\arty_d\exp_a_b\xsim_b
...
call xvlog -sv ^
  ...
  "%TB%\tb_exp_b_liveness.sv"
if errorlevel 1 exit /b 1
call xelab tb_exp_b_liveness -snapshot snap_exp_b -timescale 1ns/1ps
if errorlevel 1 exit /b 1
echo run -all> "%XD%\run_all.tcl"
echo exit>> "%XD%\run_all.tcl"
call xsim snap_exp_b -tclbatch run_all.tcl -log "%XD%\xsim.log"
if errorlevel 1 exit /b 1
