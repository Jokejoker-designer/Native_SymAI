...
set TB=%ROOT%\tb\native_ai\board
set XD=D:\FPGA\arty_d\first_divergence_01\xsim_h17_stall
...
call xvlog -sv ^
  ...
  "%TB%\tb_h17_mig_stall.sv"
if errorlevel 1 exit /b 1
call xelab tb_h17_mig_stall -snapshot snap_h17st -timescale 1ns/1ps
if errorlevel 1 exit /b 1
echo run -all> "%XD%\run_all.tcl"
echo exit>> "%XD%\run_all.tcl"
call xsim snap_h17st -tclbatch run_all.tcl -log "%XD%\xsim.log"
if errorlevel 1 exit /b 1
