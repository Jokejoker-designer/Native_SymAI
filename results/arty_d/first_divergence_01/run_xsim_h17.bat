...
set TB=%ROOT%\tb\native_ai\board
set XD=D:\FPGA\arty_d\first_divergence_01\xsim_h17
...
call xvlog -sv ^
  ...
  "%TB%\tb_h17_dest_persist.sv"
if errorlevel 1 exit /b 1
call xelab tb_h17_dest_persist -snapshot snap_h17 -timescale 1ns/1ps
if errorlevel 1 exit /b 1
echo run -all> "%XD%\run_all.tcl"
echo exit>> "%XD%\run_all.tcl"
call xsim snap_h17 -tclbatch run_all.tcl -log "%XD%\xsim.log"
if errorlevel 1 exit /b 1
