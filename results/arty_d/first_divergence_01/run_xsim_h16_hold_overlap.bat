...
set TB=%ROOT%\tb\native_ai\board
set XD=D:\FPGA\arty_d\first_divergence_01\xsim_h16_hold_overlap
if not exist "%XD%" mkdir "%XD%"
call "C:\2026.1\Vivado\settings64.bat"
cd /d "%XD%"
copy /Y "%PA%\out\PA24-A-01.mem" "%XD%\" >nul
call xvlog -sv ^
  ...
  "%TB%\tb_h16_hold_overlap.sv"
if errorlevel 1 exit /b 1
call xelab tb_h16_hold_overlap -snapshot snap_h16ho -timescale 1ns/1ps
if errorlevel 1 exit /b 1
echo run -all> "%XD%\run_all.tcl"
echo exit>> "%XD%\run_all.tcl"
call xsim snap_h16ho -tclbatch run_all.tcl -log "%XD%\xsim.log"
if errorlevel 1 exit /b 1
