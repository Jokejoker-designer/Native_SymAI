...
call xvlog -sv ^
  ...
  "%TB%\tb_h17_seq_v123.sv"
if errorlevel 1 exit /b 1
call xelab tb_h17_seq_v123 -snapshot snap_h17s -timescale 1ns/1ps
if errorlevel 1 exit /b 1
echo run -all> "%XD%\run_all.tcl"
echo exit>> "%XD%\run_all.tcl"
call xsim snap_h17s -tclbatch run_all.tcl -log "%XD%\xsim.log"
if errorlevel 1 exit /b 1
