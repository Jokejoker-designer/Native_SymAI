...
set TB=%ROOT%\tb\native_ai\board
set XD=D:\FPGA\arty_d\first_divergence_01\xsim_h19_ack_pad_a01
...
call xvlog -sv ^
  ...
  "%TB%\tb_h19_ack_pad_a01.sv"
if errorlevel 1 exit /b 1
call xelab tb_h19_ack_pad_a01 -snapshot snap_h19pad -timescale 1ns/1ps
if errorlevel 1 exit /b 1
echo run -all> "%XD%\run_all.tcl"
echo exit>> "%XD%\run_all.tcl"
call xsim snap_h19pad -tclbatch run_all.tcl -log "%XD%\xsim.log"
if errorlevel 1 exit /b 1
