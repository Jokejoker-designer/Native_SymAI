...
set TB=%ROOT%\tb\native_ai\board
set XD=D:\FPGA\arty_d\first_divergence_01\xsim_h16_a01_115200
...
call xvlog -sv ^
  ...
  "%TB%\tb_h16_a01_115200.sv"
if errorlevel 1 exit /b 1
call xelab tb_h16_a01_115200 -snapshot snap_h16a01 -timescale 1ns/1ps
if errorlevel 1 exit /b 1
echo run -all> "%XD%\run_all.tcl"
echo exit>> "%XD%\run_all.tcl"
call xsim snap_h16a01 -tclbatch run_all.tcl -log "%XD%\xsim.log"
if errorlevel 1 exit /b 1
