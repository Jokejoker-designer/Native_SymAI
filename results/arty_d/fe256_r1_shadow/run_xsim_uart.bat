...
set RTL=%ROOT%\rtl\native_ai
set XD=D:\FPGA\arty_d\fe256_r1_shadow\xsim_uart
...
call xvlog -sv -i "%ROOT%\verification\fe256" ^
  ...
  "%ROOT%\verification\fe256\tb_fe256_r1_uart_smoke.sv"
if errorlevel 1 exit /b 1
call xelab tb_fe256_r1_uart_smoke -snapshot tb_fe256_uart -timescale 1ns/1ps
if errorlevel 1 exit /b 1
echo run -all> "%XD%\run_all.tcl"
echo exit>> "%XD%\run_all.tcl"
call xsim tb_fe256_uart -tclbatch run_all.tcl -log "%XD%\xsim.log"
if errorlevel 1 exit /b 1
