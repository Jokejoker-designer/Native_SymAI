@echo off
REM UART CLEAR TB at DUT default 115200. Does not modify CANON_BLUEPRINT TB.
...
set XD=D:\FPGA\arty_d\pack_debug_clear\xsim_uart_115200
if not exist "%XD%" mkdir "%XD%"
call "C:\2026.1\Vivado\settings64.bat"
cd /d "%XD%"
copy /Y "%PA%\out\PA24-V-01.mem" "%XD%\" >nul
copy /Y "%PA%\out\PA24-V-02.mem" "%XD%\" >nul
copy /Y "%PA%\out\PA24-R-04.mem" "%XD%\" >nul
call xvlog -sv ^
  ...
  "%TB%\tb_pack_debug_clear_115200.sv"
if errorlevel 1 exit /b 1
call xelab tb_pack_debug_clear -snapshot snap_clr_115200 -timescale 1ns/1ps
if errorlevel 1 exit /b 1
echo run -all> "%XD%\run_all.tcl"
echo exit>> "%XD%\run_all.tcl"
call xsim snap_clr_115200 -tclbatch run_all.tcl -log "%XD%\xsim.log"
if errorlevel 1 exit /b 1
