// tb_pack_debug_clear_115200.sv — copy of live TB with BAUD=115200 (DUT default).
// D-owned experiment. Does not modify CANON_BLUEPRINT tb_pack_debug_clear.sv.
// Not PACK_ABI / not PACK_ABI_24_24_PASS. Not BOARD_PASS.
...
module tb_pack_debug_clear;
  ...
  int nwords, pass, fail, ghost, i, c;
  ...
  initial begin
    ...
    send_word(CLR_CMD);
    wait_status(CLR_ACK, 2_000_000);
    load_mem("PA24-V-01.mem");
    send_pack();
    wait_status(32'h010000A5, 20_000_000);

    // T2 history
    load_mem("PA24-V-01.mem");
    send_pack();
    wait_status(32'h02000E5A, 20_000_000);
    ...
    send_word(vec[1]);
    send_word(CLR_CMD);
    wait_status(CLR_BUSY, 2_000_000);
