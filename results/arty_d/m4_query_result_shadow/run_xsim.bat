...
set RTL=%ROOT%\rtl\native_ai
set XD=D:\FPGA\arty_d\m4_query_result_shadow\xsim
...
call xvlog -sv ^
  ...
  "%ROOT%\tb\native_ai\board\tb_m4_query_result_shadow_bind.sv"
if errorlevel 1 exit /b 1
call xelab tb_m4_query_result_shadow_bind -snapshot tb_m4_shadow -timescale 1ns/1ps
if errorlevel 1 exit /b 1
echo run -all> "%XD%\run_all.tcl"
echo exit>> "%XD%\run_all.tcl"
call xsim tb_m4_shadow -tclbatch run_all.tcl -log "%XD%\xsim.log"
if errorlevel 1 exit /b 1
