# Closed JA top. Not implemented. Not a bitstream.
# Board silkscreen: REV E.
# Current Digilent master header names Rev. D and Rev. E.
# CONNECTOR_PIN JA1 = PACKAGE_PIN G13 = RTL_PORT effect_drive
# CONNECTOR_PIN JA2 = PACKAGE_PIN B11 = RTL_PORT effect_sense
# led0 is a witness of effect_drive. It is not the observation.
# PULLTYPE PULLDOWN is not proven by RTL simulation.
