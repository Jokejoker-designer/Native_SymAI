...
- `docs/audits/20260921_fem_persist_legal_compact_1db38691/` legal compact UART CANDIDATE on same SHA

SRAM last programmed `1db38691…` (21:33+07; this-run no reprogram). dest TAP bit file on disk **UNTOUCHED**. **8/8 NOT_RUN.** **PROGRAM_PASS=NO.** **PACK_ABI_24_24_PASS=NO.** **FEM_PERSIST_PASS=NO.** No `.bit` in git.
